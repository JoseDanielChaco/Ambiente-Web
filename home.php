        ...
        <div class="container">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu">
                    ...
                    ?>
                        <li><a class="dropdown-item" href="#" category="<?php echo $data['categoria']; ?>"><?php echo $data['categoria']; ?></a></li>
                    <?php } ?>
                </ul>
                </li>
                <li class="nav-item">
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                            <div class="card h-100">
                                ...
                                <!-- Imagen-->
                                <img class="card-img-top" src="<?php echo $data['imagen']; ?>" alt="..." style="max-width: 100%; max-height: 200px;" />
                                <!-- Detalles-->
